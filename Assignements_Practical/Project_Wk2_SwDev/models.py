...
===================================
Maps every table in seed.sql to a Python class.
These classes are the bridge between the database schema and Python code.
"""

from sqlalchemy import (
    Column, Integer, SmallInteger, String, Numeric,
    Date, Text, LargeBinary, ForeignKey,
)
...
class OrderDetail(Base):
    ...
    orderNumber = Column(
        Integer, ForeignKey("orders.orderNumber"), primary_key=True
    )
    productCode = Column(
